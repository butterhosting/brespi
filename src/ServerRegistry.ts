...
export class ServerRegistry {
  ...
  private constructor(
    ...
    const { notificationRepository } = this.register({ NotificationRepository }, [configurationRepository, sqlite]);
    ...
    const { executionService } = this.register({ ExecutionService }, [
      env,
      executionRepository,
      pipelineRepository,
      adapterService,
    ...
    const { scheduleService } = this.register({ ScheduleService }, [
      env,
      eventBus,
      scheduleRepository,
      pipelineRepository,
